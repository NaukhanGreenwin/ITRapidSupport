...
export const allResources: ResourceItem[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Co-managed IT is a partnership with your existing internal IT person or team. Instead of replacing them, the provider fills specific gaps: after-hours and weekend coverage, advanced cybersecurity, project capacity, specialized expertise, and the monitoring and patching tools that are expensive to license alone. Your internal staff keep day-to-day familiarity and control while gaining the depth and coverage of a full team behind them.",
      "## Comparing the Two Side by Side",
