  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <SEO
        ...
        description="24/7 IT support for Toronto businesses: managed helpdesk, proactive monitoring, on-site support, and rapid response across the GTA. Call (289) 582-9930."
