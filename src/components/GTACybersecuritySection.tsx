        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-700 mb-3">
              ...
              is available 24/7 — new clients welcome.
            </p>
            <p className="text-gray-700 mb-6">
              We work from our office at 7810 Keele St, so the same team that monitors your systems can be on site rather than
              dispatched across the region. See what that covers on our <Link to="/it-support/vaughan/" className="text-red-600 hover:text-red-700 font-medium">managed IT services in Vaughan</Link>, <Link to="/it-support/mississauga/" className="text-red-600 hover:text-red-700 font-medium">managed IT services in Mississauga</Link>,
              and <Link to="/it-support/brampton/" className="text-red-600 hover:text-red-700 font-medium">IT support in Brampton</Link> pages,
              or start with our plain-language guide to <Link to="/resources/cybersecurity-services-toronto-guide/" className="text-red-600 hover:text-red-700 font-medium">cybersecurity services in Toronto</Link>.
            </p>
            <p className="text-gray-700 mb-6">
              Want to know where you stand first? Our free <Link to="/it-risk-calculator/" className="text-red-600 hover:text-red-700 font-medium">IT risk calculator</Link> scores
              fifteen security control areas and tells you what to fix first — no sign-up, and nothing you enter leaves your browser.
            </p>
          </div>
